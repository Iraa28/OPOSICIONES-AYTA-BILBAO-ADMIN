const questions = [
	...
	//294
	{
		...
		answers: [
			{text: "a) El tratamiento esté basado en el consentimiento o en un contrato y el tratamiento se efectúe por medios automatizados.", correct: true},
			{text: "b) El tratamiento esté basado únicamente en el consentimiento y el tratamiento se efectúe por medios no automatizados.", correct: false},
			{text: "c) El tratamiento esté basado en el consentimiento o en un contrato o en una obligación personal y el tratamiento se efectúe por medios informáticos.", correct: false},
